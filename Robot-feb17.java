...
public class Robot extends IterativeRobot {
  ...
  public void autonomousInit() {
    ...
    */
    ...
    /*		 if (timer.get() < 1.5) {
    		 ...
    		 else if (timer.get() > 2.2 && timer.get() < 3.5)
    			{driveTrain.drive(0.57, 0.61);}
    			...
    			driveTrain.drive(0.0, 0.0, 0);
    		 	...
    		 	else if (timer.get() > 1.75 && timer.get() < 2.6) {
    				driveTrain.drive(-0.57, -0.61);
    			}
  ...
  public void teleopPeriodic() {
    ...
    driveTrain.drive2(joystick.getRawAxis(Constants.JOYSTICK_ROLLERL1_DRIVE_AXIS),
        joystick.getRawAxis(Constants.JOYSTICK_ROLLERR1_DRIVE_AXIS),
        joystick.getRawAxis(Constants.JOYSTICK_EXTEND1_DRIVE_AXIS));
